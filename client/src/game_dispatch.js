...
import { init_global_obj_y_params, save_srv_response_NewGame, init_new_game_data } from './data.js'
...
export async function init_newGame_dispatcher() {
    ...
    // all these inits should go into main, and here we call a single function
    init_global_obj_y_params();
    ...
    try{
        ...
        save_srv_response_NewGame(srv_newGame_resp);
